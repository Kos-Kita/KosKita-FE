...
const BookingPage = () => {
  ...
  const getData = async () => {
    try {
      ...
      setPembayaran((prev) => ({ ...prev, kos_id: parseInt(id) }));
    } catch (error: any) {
      toast({
              ...
              <div className="flex gap-5 max-md:flex-col max-md:gap-0 max-md:">
                <div className="flex flex-col w-[55%] max-md:ml-0 max-md:w-full">
                  <div className="flex flex-col pb-4 font-bold leading-[133%] text-neutral-900 max-md:mt-10 max-md:max-w-full">
                    <div className="text-5xl leading-[59.8px] max-md:max-w-full max-md:text-4xl">
                      Booking review
                    </div>
                    <div className="flex gap-5 justify-start mt-16 text-lg max-md:flex-wrap max-md:mt-10 max-md:max-w-full">
                      ...
                      <div className="flex-auto">
                        {<NumberFormatter value={parseInt(data.price)} />}
                      </div>
                    </div>
                    ...
                    <div className="mt-9 text-base tracking-wide text-black max-md:max-w-full">
                      Tanggal kamu mulai mengkos yang tersedia
                    </div>
                    <div className="mt-9 text-base tracking-wide text-black max-md:max-w-full">
                      Tanggal kamu mulai ngekos{" "}
                    </div>
                    <div className="flex gap-5 justify-start mt-3.5 text-xl tracking-wide leading-8 text-black text-opacity-90 max-md:flex-wrap max-md:max-w-full">
                      <div className="flex gap-5 justify-between px-9 py-3 rounded-md bg-neutral-800 bg-opacity-10 max-md:px-5">
                        ...
                        <img
                          loading="lazy"
                          src="https://cdn.builder.io/api/v1/image/assets/TEMP/c0a0c902b8a9baeaddb815dae11ad0409613584194195c98488cdeb0e797b521?"
                    ...
                    <button
                      ...
                      className="justify-center self-center px-10 py-3 mt-10 text-lg text-white whitespace-nowrap bg-lime-600 rounded-[40px] max-md:px-5"
                    >
                      Confirm and pay
                    </button>
                  </div>
                ...
                <div className="flex flex-col ml-5 w-[45%] max-md:ml-0 max-md:w-full">
                  <div className="flex flex-col grow mt-3 text-lg text-neutral-900 max-md:mt-10 max-md:max-w-full">
                    <div className="flex flex-col bg-zinc-100 rounded-[30px] max-md:max-w-full overflow-hidden">
                      <img
                        loading="lazy"
                        srcSet="https://infokost.id/wp-content/uploads/2022/02/Ruoptions-HD-Depok_Juni2021_11_edited-1.jpg"
                      ...
                      <div className="flex flex-col px-10 pb-10 mt-10 max-md:px-5 max-md:max-w-full">
                        <div className="font-bold leading-[133%] text-center max-md:max-w-full">
                          Tips ngekos!
                        </div>
                      ...
                      <>
                        ...
                        <div className="fixed inset-0 flex items-center justify-center z-50 font-Poppins">
                          <div className="bg-white w-[25rem] p-8 rounded shadow-lg">
                            <p className="my-2 text-2xl font-semibold text-lime-600">
                              Detail Pembayaran
                            </p>
                            <p className="my-2 text-sm">
                              Booking code: {`${dPayment.booking_code}`}
                            </p>
                            <hr />
                            ...
                            <div className="mb-4 bg-orange-200 p-3 flex items-center justify-between rounded text-lg font-bold">
                              ...
                              <img
                                ...
                                width="24"
                                height="24"
                                src="https://img.icons8.com/material-sharp/24/copy.png"
                                alt="copy"
                            ...
                            <p className="my-2 text-sm flex justify-end">
                              Waktu Berakhir:{" "}
                              <span className="text-red-500 ml-2"> {formatTime(popupTimer)}</span>
                            </p>
                            <div className="flex gap-3">
                              <button
                                className="bg-gray-500 text-white px-4 py-2 mt-5 rounded hover:bg-gray-600"
                                onClick={closePopup}
                              >
                                Tutup
                              </button>
                    ...
                    <div className="flex flex-col pl-10">
                      <div className="self-start my-6  font-bold whitespace-nowrap leading-[133%] max-md:mt-10 max-md:ml-2.5">
                        Jenis pembayaran yang di dukung.
                      </div>

                      <div className="flex gap-5 justify-between self-start mt-2.5 text-sm leading-6 text-black max-md:mr-2.5">
                        <img
                          loading="lazy"
                          src="https://cdn.builder.io/api/v1/image/assets/TEMP/072acca096013ce55657bccf1875e5c554fed78a6ca74f7a927bfe2dce2a6443?"
                      ...
                      <div className="flex gap-5 justify-between self-start mt-2.5 text-sm leading-6 text-black max-md:mr-2.5">
                        <img
                          loading="lazy"
                          src="https://cdn.builder.io/api/v1/image/assets/TEMP/6c33a2eb40c589f742c070f1deee579712c7e39763e83012190e5ea1718316dd?"
                          className="mt-3 aspect-[1.59] w-[38px]"
                        />
                      ...
                      <div className="flex gap-5 justify-between self-start mt-2.5 text-sm leading-6 text-black max-md:mr-2.5">
                        <img
                          loading="lazy"
                          src="https://cdn.builder.io/api/v1/image/assets/TEMP/7c738610508bb3ef8251eeac8b19e91ce93c20b12114b96b4faed587a2c5bfa8?"
                          className="aspect-[1.59] w-[38px]"
                        />
                      ...
                      <div className="flex gap-5 justify-between self-start mt-2.5 text-sm leading-6 text-black max-md:mr-2.5">
                        <img
                          loading="lazy"
                          src="https://cdn.builder.io/api/v1/image/assets/TEMP/d6e204ab331675835af9e70459d39780cd517182706e609fc76674cd7baa5cdf?"
                          className="aspect-[1.59] w-[38px]"
                        />
                      ...
                      <div className="flex gap-5 justify-between self-start mt-2.5 text-sm leading-6 text-black max-md:mr-2.5">
                        <img
                          loading="lazy"
                          src="https://cdn.builder.io/api/v1/image/assets/TEMP/a0ff8b84e12e7f63f7e9d64f8776e59fbfb641d358121e0cc2ee0b25cd4d206c?"
                          className="mt-2.5 aspect-[1.59] w-[38px]"
                        />
