...
const BookingPage = () => {
  ...
  return (
    <>
      <Layout>
        <div className="container flex flex-col pb-7 bg-white border-t-2 border-b-slate-50">
          <div className="flex flex-col items-center md:px-5 md:mt-10 w-full  mt-5 max-md:max-w-full">
              ...
              <div className="flex gap-5 max-md:flex-col max-md:gap-0 max-md:">
                <div className="flex flex-col w-[55%] max-md:ml-0 max-md:w-full">
                  <div className="flex flex-col pb-4 font-bold leading-[133%] text-neutral-900 max-md:mt-10 max-md:max-w-full">
                    ...
                    <div className="flex gap-5 justify-start mt-5 md:mt-10 text-lg max-md:flex-wrap max-md:max-w-full">
                      <div className="font-semibold md:text-base text-sm">Harga Kos-kosan perbulan</div>
                      <div className="flex-auto md:text-base text-sm">{<NumberFormatter value={parseInt(data.price)} />}</div>
                    </div>
                    <div className="flex gap-5 justify-between my-5 md:mt-8 text-lg md:text-2xl max-md:flex-wrap max-md:max-w-full">
                      <div>Total</div>
                      <div className="flex-auto">{<NumberFormatter value={parseInt(data.price)} />}</div>
                    </div>
                    <div className="md:my-3 mb-5 md:mb-0 text-base tracking-wide text-black max-md:max-w-full">Tanggal kamu mulai ngekos </div>
                    <div className="flex md:gap-5 gap-3 justify-start mt-3.5 text-xl tracking-wide leading-8 text-black text-opacity-90 max-md:flex-wrap max-md:max-w-full">
                      <div className="flex md:gap-3 gap-2 justify-between py-2 px-3 text-sm md:text-base md:px-9 md:py-3 rounded-md bg-neutral-800 bg-opacity-10 ">
                    ...
                    <div className="flex gap-2.5 justify-between md:w-[65%] mt-10 text-sm leading-6 bg-white rounded-md  text-slate-900 max-md:flex-wrap max-md:max-w-full">
                      <select
                    ...
                    <button onClick={createPayment} className="justify-center md:self-start self-center px-10 py-3 mt-10 text-lg text-white whitespace-nowrap bg-lime-600 rounded-[40px] max-md:px-5">
                      Confirm and pay
                    </button>
                  </div>
                </div>
                <div className="flex flex-col ml-5 w-[45%] max-md:ml-0 max-md:w-full">
                  <div className="flex flex-col grow mt-3 text-lg text-neutral-900 max-md:mt-10 max-md:max-w-full">
                    <div className="flex flex-col bg-zinc-100 rounded-[30px] max-md:max-w-full overflow-hidden">
                      ...
                      <div className="flex flex-col px-10 pb-10 mt-10 max-md:px-5 max-md:max-w-full">
                        ...
                        <div className="mt-5 text-sm leading-6 text-center max-md:max-w-full">
                          Usahakan sebelum kamu payment untuk mengkos, kamu menghubungi pihak penyedia kos-kosan di menu chat. Untuk meminimalisir kesalahpahaman atau sesuatu yang tidak di inginkan. &gt;,&lt;
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col md:pl-10">
                      ...
                      <div className="flex flex-col ml-2 md:ml-0 justify-center items-center">
