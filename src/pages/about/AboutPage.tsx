...
const AboutUsPage: React.FC = () => {
  return (
    <div>
      <Navbar />
      <div className="bg-cover bg-center flex items-center bg-black py-24" style={{ backgroundImage: 'url("https://putrasionmandiri.co.id/wp-content/uploads/2023/08/trip-3_13-Photo.jpg")', filter: "blur(0.1px)" }}>
