    ...
    <div className="min-h-screen flex items-center justify-center">
      <div className="bg-white shadow flex flex-col items-center gap-5 max-w-md w-full p-3">
        ...
        <h2 className="text-3xl font-semibold">
          ...
          <span
            className={`${
              tabParam === "renter" ? "text-[#4CA02E]" : "text-[#B6A563]"
            }`}
          >
        ...
        <button className="px-8 p-2 bg-[#4CA02E] text-white rounded-2xl">
          Login
        </button>
        <span className="text-sm text-[#4CA02E]">Lupa Password</span>
        <p className="font-medium">
          Belum Punya akun? <span className="text-[#4CA02E]">Sign up</span>
        </p>
      </div>
    </div>
  );
